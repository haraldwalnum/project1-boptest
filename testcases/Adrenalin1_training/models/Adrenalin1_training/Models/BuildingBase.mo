...
final parameter Modelica.SIunits.MassFlowRate m_flow_nominal_water_rad=3
...
Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam=
        ModelicaServices.ExternalReferences.loadResource("Adrenalin1_training/Resources/Climate/DNK_Copenhagen.061800_IWEC.mos"))
  annotation (Placement(transformation(extent={{238,140},{218,160}})));
...
Modelica.Thermal.HeatTransfer.Sources.FixedTemperature tPipHeaLoss(T(
  ...
  Buildings.Utilities.IO.SignalExchange.Read reaOcc(
    ...
    annotation (Placement(transformation(extent={{-140,122},{-124,138}})));
...
connect(matrixGain.u[1], metHeat.y)
  ...
  connect(occupancy.y[1],reaOcc. u)
    annotation (Line(points={{-161,130},{-141.6,130}}, color={0,0,127}));
  connect(reaOcc.y, metHeat.u) annotation (Line(points={{-123.2,130},{-110,130},
          {-110,144},{-105.6,144}}, color={0,0,127}));
  connect(reaOcc.y, gaiCO2.u) annotation (Line(points={{-123.2,130},{-110,130},
          {-110,112},{-107.6,112}}, color={0,0,127}));
